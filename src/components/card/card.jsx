import productdata from "../../../src/data/db.json";
import styles from "./card.module.scss";
const prdtdata = productdata.productdata;
export const Card = () => {
  return (
    <div className={styles.cardcontainer}>
      {prdtdata.map((item, ind) => {
        return (
          <div className={styles.card}>
            ...
            <div className={styles.carddiscp}>
              <p>
                <b>{item.heading}</b>
                {item.headingtext}
              </p>
              <b className={styles.mainhighlight}>Main highlights</b>
              <p className={styles.mainhighlightpara}>{item.description}</p>
            ...
            <div className={styles.cardrating}>
              <div className={styles.cardratingmain}>
                <p className={styles.boldrating}>{item.rating}</p>
                <p>{item.ratingmsg}</p>
                {item.star === 5 ? (
                  <svg
                    width="66"
